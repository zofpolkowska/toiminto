...
-module(toiminto_tokenizer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 42).
...
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.erl", 319).
yystate() -> 29.
...
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 62, C =< 64 ->
    yystate(31, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 91, C =< 96 ->
    yystate(31, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 108 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 112, C =< 118 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 120, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 123 ->
    yystate(31, Ics, Line, Tlen+1, Action, Alen);
...
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(5, Ics, Line, Tlen+1, 11, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, 11, Tlen);
...
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 10).
yyaction_0(TokenChars, TokenLine) ->
     { token, { mods, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 11).
yyaction_1(TokenChars, TokenLine) ->
     { token, { where, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 12).
yyaction_2(TokenChars, TokenLine) ->
     { token, { otherwise, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 14).
yyaction_3(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 17).
yyaction_4(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 18).
yyaction_5(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 19).
yyaction_6(TokenLine) ->
     { token, { '*', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 20).
yyaction_7(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 21).
yyaction_8(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 22).
yyaction_9(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 25).
yyaction_10(TokenLine) ->
     { token, { '<', TokenLine } } .

-compile({inline,yyaction_11/2}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 28).
yyaction_11(TokenChars, TokenLine) ->
     { token, { name, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_12/2}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 30).
yyaction_12(TokenChars, TokenLine) ->
     { token, { module, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_13/1}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 33).
yyaction_13(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_14/0}).
-file("/home/elfowl/Projects/Erlang/haskerl/_build/default/lib/haskerl/src/toiminto_tokenizer.xrl", 38).
yyaction_14() ->
     skip_token .
